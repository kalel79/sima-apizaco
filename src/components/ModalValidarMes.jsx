  ...
  return (
    <div style={{position:'fixed',inset:0,background:'#000000aa',display:'flex',alignItems:'center',justifyContent:'center',zIndex:200}}
      ...
      <div onClick={e=>e.stopPropagation()} style={{background:C.bgCard,border:`1px solid ${C.dorado}55`,borderRadius:12,padding:'1.3rem',width:320,maxWidth:'90vw'}}>
        <div style={{fontSize:'0.85rem',fontWeight:700,color:C.txt,marginBottom:8,display:'flex',alignItems:'center',gap:7}}><Lock size={15}/> Confirmar validación</div>
        ...
        {error && <div style={{fontSize:'0.72rem',color:C.criticoB,marginBottom:10,display:'flex',alignItems:'center',gap:6}}><XCircle size={13}/> {error}</div>}
